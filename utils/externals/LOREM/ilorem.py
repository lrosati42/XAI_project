...
class ILOREM(object):
    ...
    def __init__(self, bb_predict, class_name, class_values, neigh_type='lime', ocr=0.1,
        ...
        """
        Arguments:
            - bb_predict: Predict function of the black box, need to deal with a list of image_examples as input and return an array of dimension(len(input),1) of the predicted class index
            ...
            - segmentation_fn: Segmentation Function to segment the image_examples
        """
